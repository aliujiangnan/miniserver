...
public:
    ...
    void workerRPC(int workerindex, uint16_t cmd, const std::string& data, Function<void(const std::string&)> func);
    void workerRPCForScript(int workerindex, uint16_t cmd, const std::string& data, ScriptArgObjPtr func);
    void asyncHttp(const std::string& url_, int timeoutsec, Function<void(const std::string&)> func);
    void asyncHttpForScript(const std::string& url_, int timeoutsec, ScriptArgObjPtr func);
